...
/// Distinguishes an active task from a completed one in the task picker.
///
/// The kind drives ``TaskRowView``'s leading button, title style, primary-metadata slot, and
/// optional trailing delete button.
enum TaskItemKind {
