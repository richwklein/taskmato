...
struct FocusAttributionTests {
  ...
  @Test func stagingATaskDuringFocusDoesNotAffectAttribution() {
    // `ActiveTaskStore.stage(_:)` fires no `onActiveTaskChanged`, so wiring it exactly as
