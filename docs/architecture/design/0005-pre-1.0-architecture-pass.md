...
Proposed 2026-06-05. Tracks architectural work across milestones 0.7.0 (foundation + DRY), 0.8.0 (SwiftData session migration), and 0.9.0 (registry split, Swift 6, polish). Sequenced PRs land independently per AGENTS.md "one logical change per run." The registry split's new boundary is recorded in [ADR-0008](../decisions/0008-split-task-registry.md).
